...
tags = ['raspberry-pi','aws','iot','python','greatest-hits']
categories = []
externalLink = ""
series = []
+++
...
After getting some off-the-shelf code up and running, I wanted to rethink the software. The resulting code is [available on GitHub](https://github.com/AlexJReid/joedisplay).

The train display board case study has been implemented using AWS IoT together with the approaches discussed in this document. See [UK Train Departures Board replica built with a Raspberry Pi and AWS IoT](https://github.com/AlexJReid/joedisplay/blob/master/AWSIOT.md).
...
If you're interested in the generic approach of driving an OLED display attached to a Pi, see [Driving the display in a generic way](#driving-the-display-in-a-generic-way).
...
- A [clone of this repo](https://github.com/AlexJReid/joedisplay)
...
Comments, PRs, feedback and suggestions are most welcome. 
